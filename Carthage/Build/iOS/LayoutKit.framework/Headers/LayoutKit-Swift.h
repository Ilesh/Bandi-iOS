...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="LayoutKit",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif


/// A set of updates to apply to a <code>ReloadableView</code>.
/// Inherits from NSObject in order to be exposable to Objective-C.
/// Objective-C exposability is needed in order to override methods from extensions that use <code>BatchUpdates</code> as parameter.
SWIFT_CLASS("_TtC9LayoutKit12BatchUpdates")
@interface BatchUpdates : NSObject
...
SWIFT_CLASS("_TtC9LayoutKit27LayoutAdapterCollectionView")
@interface LayoutAdapterCollectionView : UICollectionView
...
SWIFT_CLASS("_TtC9LayoutKit22LayoutAdapterTableView")
@interface LayoutAdapterTableView : UITableView
...
SWIFT_CLASS("_TtC9LayoutKit27ReloadableViewLayoutAdapter")
@interface ReloadableViewLayoutAdapter : NSObject
...
@interface ReloadableViewLayoutAdapter (SWIFT_EXTENSION(LayoutKit)) <UITableViewDataSource>
/// warning:
...
@interface ReloadableViewLayoutAdapter (SWIFT_EXTENSION(LayoutKit)) <UICollectionViewDelegateFlowLayout>
/// warning:
/// Subclasses that override this method must call super
...
@interface ReloadableViewLayoutAdapter (SWIFT_EXTENSION(LayoutKit)) <UICollectionViewDataSource>
/// warning:
/// Subclasses that override this method must call super
...
@interface ReloadableViewLayoutAdapter (SWIFT_EXTENSION(LayoutKit)) <UITableViewDelegate>
/// warning:
/// Subclasses that override this method must call super
...
SWIFT_CLASS("_TtC9LayoutKit9StackView")
...
@interface UICollectionView (SWIFT_EXTENSION(LayoutKit))
- (void)reloadDataSynchronously;
- (void)registerViewsWithReuseIdentifier:(NSString * _Nonnull)reuseIdentifier;
- (void)performWithBatchUpdates:(BatchUpdates * _Nonnull)batchUpdates completion:(void (^ _Nullable)(void))completion;
@end


@interface UITableView (SWIFT_EXTENSION(LayoutKit))
- (void)reloadDataSynchronously;
- (void)registerViewsWithReuseIdentifier:(NSString * _Nonnull)reuseIdentifier;
- (void)performWithBatchUpdates:(BatchUpdates * _Nonnull)batchUpdates completion:(void (^ _Nullable)(void))completion;
@end
